...
def get_comprehensive_vehicle_details(rc_number: str) -> dict:
    ...
    try:
        ...
        return {"error": f"Failed to fetch data: {str(e)}", "status": "error"}
    ...
    data = {
        ...
        "other_info": {
            "financer": other.get("financer_name") or other.get("financier_name") or get_value("Financer Name"),
...
def handler(request):
    ...
    if request.path == "/" or request.path == "":
        return {
            ...
            "body": json.dumps({
                ...
                "api_endpoint": "/api/vehicle-info?rc=<RC_NUMBER>",
    ...
    return {
        ...
        "body": json.dumps({
            ...
            "status": "error",
            "available_endpoints": ["/", "/api/vehicle-info?rc=<RC_NUMBER>", "/health"]
        })
    }
